<?php
if ( ! function_exists( 'playerx_edge_init_google_fonts_array' ) ) {
    function playerx_edge_init_google_fonts_array() {
        ...
        $playerx_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'playerx_edge_init_google_fonts_array');
}