...
class PlayerxEdgeClassMatchFeaturedWidget extends PlayerxEdgeClassWidget {
	protected $params;

	public function __construct() {
		parent::__construct(
			'edgtf_match_featured_list_widget', // Base ID
			esc_html__('Playerx Match Featured List', 'playerx-core'), // Name
	...
	protected function setParams() {
		$this->params = array(
            ...
            array(
                'name'    => 'show_result',
                'type'    => 'dropdown',
                'title'   => esc_html__('Show Result', 'playerx-core'),
                'options' => array(
                    'no'  => esc_html__('No', 'playerx-core'),
                    'yes' => esc_html__('Yes', 'playerx-core'),
                )
	...
	public function widget($args, $instance) {
		...
		echo '<div class="widget edgtf-match-featured-list-widget">';

		if (!empty($instance['title'])) {
            echo playerx_edge_get_module_part( $args['before_title'] . $instance['title'] . $args['after_title'] );
		}

		echo playerx_edge_execute_shortcode('edgtf_match_featured', $params);
