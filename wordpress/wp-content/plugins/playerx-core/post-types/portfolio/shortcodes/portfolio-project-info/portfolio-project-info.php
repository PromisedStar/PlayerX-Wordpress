...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'playerx-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'playerx-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Title', 'playerx-core' )          => 'title',
								esc_html__( 'Category', 'playerx-core' )       => 'category',
								esc_html__( 'Tag', 'playerx-core' )            => 'tag',
								esc_html__( 'Author', 'playerx-core' )         => 'author',
								esc_html__( 'Date', 'playerx-core' )           => 'date',
								esc_html__( 'Featured Image', 'playerx-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Label', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Project Info Label Tag', 'playerx-core' ),
							'value'      => array_flip( playerx_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
