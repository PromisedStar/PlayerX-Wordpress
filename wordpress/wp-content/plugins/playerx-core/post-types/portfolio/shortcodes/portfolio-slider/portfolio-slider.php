...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'playerx-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'playerx-core' ),
							'admin_label' => true,
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Fullheight slider?', 'playerx-core' ),
                            'value'      => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
                        ),
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'portfolio_slider_full_height_decrease',
                            'heading'     => esc_html__( 'Decrease Slider Height for Header and Title Height?', 'playerx-core' ),
                            'value'       => array(
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Enable Center Item', 'playerx-core' ),
                            'value'       => array_flip( playerx_edge_get_yes_no_select_array( false, true ) ),
                            'save_always' => true,
                            'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
                        ),
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'playerx-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
								esc_html__( 'Light', 'playerx-core' )   => 'light',
								esc_html__( 'Dark', 'playerx-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'playerx-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'playerx-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'playerx-core' )
