<div class="edgtf-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="edgtf-testimonials edgtf-owl-slider" <?php echo playerx_edge_get_inline_attrs( $data_attr ) ?>>
    ...
    ?>
            ...
            <div class="edgtf-testimonial-content" id="edgtf-testimonials-<?php echo esc_attr( $current_id ) ?>">
                <div class="edgtf-testimonial-text-holder">
                    <?php if ( ! empty( $title ) ) { ?>
                        <h3 itemprop="name" class="edgtf-testimonial-title entry-title"><?php echo esc_html( $title ); ?></h3>
                    <?php } ?>
                    <?php if ( ! empty( $text ) ) { ?>
    ...
    <?php
        ...
        echo esc_html__( 'Sorry, no posts matched your criteria.', 'playerx-core' );
    endif;
