<?php
namespace PlayerxCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'playerx-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'playerx-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'playerx-core' )   => 'edgtf-visible-on-hover',
								esc_html__( 'Visible on Default', 'playerx-core' ) => 'edgtf-visible-on-default',
								esc_html__( 'Disabled', 'playerx-core' )           => 'edgtf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Default', 'playerx-core' )  => 'default',
								esc_html__( 'Centered', 'playerx-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'playerx-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subtitle', 'playerx-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subtitle Tag', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'playerx-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'playerx-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'playerx-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'playerx-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'playerx-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
