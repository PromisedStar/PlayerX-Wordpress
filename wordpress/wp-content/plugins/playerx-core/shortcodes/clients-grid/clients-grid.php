<?php
namespace PlayerxCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'playerx-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'playerx-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'playerx-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );
