<?php
namespace PlayerxCore\CPT\Shortcodes\ElementsHolder;
...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'playerx-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'playerx-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'playerx-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Middle', 'playerx-core' ) => 'middle',
								esc_html__( 'Top', 'playerx-core' )    => 'top',
								esc_html__( 'Bottom', 'playerx-core' ) => 'bottom'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'playerx-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1367px-1600px', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'playerx-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'playerx-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1366',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1366px', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'playerx-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'playerx-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'playerx-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'playerx-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'playerx-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'playerx-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'playerx-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'playerx-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'playerx-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
