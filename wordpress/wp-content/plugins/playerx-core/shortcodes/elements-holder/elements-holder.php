...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'playerx-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'playerx-core' )  => 'one-column',
								esc_html__( '2 Columns', 'playerx-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'playerx-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'playerx-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'playerx-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'playerx-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'playerx-core' ),
							'value'      => array( 'Make Items Float Left?' => 'yes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'switch_to_one_column',
							'heading'     => esc_html__( 'Switch to One Column', 'playerx-core' ),
							'value'       => array(
								...
								esc_html__( 'Never', 'playerx-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'playerx-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . playerx_edge_get_class_attribute( $holder_classes ) . ' ' . playerx_edge_get_inline_attr( $holder_styles, 'style' ) . '>';
