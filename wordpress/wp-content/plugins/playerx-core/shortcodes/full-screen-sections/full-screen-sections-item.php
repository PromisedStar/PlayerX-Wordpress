...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'playerx-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'playerx-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Size', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'playerx-core' )   => 'cover',
								esc_html__( 'Contain', 'playerx-core' ) => 'contain',
								esc_html__( 'Inherit', 'playerx-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'playerx-core' ),
							'value'       => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__('Background Image for Laptops', 'playerx-core'),
							'group'       => esc_html__('Responsiveness', 'playerx-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'playerx-core'),
							'group'       => esc_html__('Responsiveness', 'playerx-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'playerx-core'),
							'group'       => esc_html__('Responsiveness', 'playerx-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'playerx-core'),
							'group'       => esc_html__('Responsiveness', 'playerx-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
