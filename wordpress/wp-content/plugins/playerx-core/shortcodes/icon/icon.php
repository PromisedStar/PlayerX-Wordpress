<?php
namespace PlayerxCore\CPT\Shortcodes\Icon;
...
class Icon implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Icon', 'playerx-core' ),
				    'base'                      => $this->base,
					    ...
					    array(
						    array(
							    ...
							    'value'      => array(
								    ...
								    esc_html__( 'Huge', 'playerx-core' )   => 'edgtf-icon-huge'
							    )
						    ),
						    array(
							    'type'       => 'textfield',
							    'param_name' => 'custom_size',
							    'heading'    => esc_html__( 'Custom Size (px)', 'playerx-core' )
						    ),
						    array(
							    'type'       => 'dropdown',
							    'param_name' => 'type',
						    ...
						    array(
							    ...
							    'heading'     => esc_html__( 'Border Radius', 'playerx-core' ),
						    ...
						    array(
							    ...
							    'heading'    => esc_html__( 'Border Width', 'playerx-core' ),
							    'dependency' => array( 'element' => 'type', 'value'   => array( 'edgtf-circle', 'edgtf-square' ) )
						    ),
						    array(
							    'type'       => 'colorpicker',
						    ...
						    array(
							    ...
							    'heading'    => esc_html__( 'Hover Icon Color', 'playerx-core' )
						    ),
						    array(
							    'type'       => 'colorpicker',
						    ...
						    array(
							    ...
							    'heading'     => esc_html__( 'Use Link as Anchor', 'playerx-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/icon', 'icon', '', $params );
