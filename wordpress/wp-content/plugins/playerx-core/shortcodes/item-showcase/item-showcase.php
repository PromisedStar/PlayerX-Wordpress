...
class ItemShowcase implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Item Showcase', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Top Offset', 'playerx-core' ),
							'value'       => '-100px',
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="edgtf-item-showcase-holder clearfix">';
			...
			if ( ! empty( $item_image ) ) {
				$html .= '<div class="edgtf-is-image" ' . playerx_edge_get_inline_style( $item_image_style ) . '>';
