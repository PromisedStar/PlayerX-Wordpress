<?php
namespace PlayerxCore\CPT\Shortcodes\Tabs;
...
class Tabs implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Tabs', 'playerx-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Vertical', 'playerx-core' ) => 'vertical'
							),
							'save_always' => true
						),
                        array(
                            ...
                            'heading'    => esc_html__( 'Predefined Skin?', 'playerx-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$output = playerx_core_get_shortcode_module_template_part( 'templates/tab-template', 'tabs', '', $params );
