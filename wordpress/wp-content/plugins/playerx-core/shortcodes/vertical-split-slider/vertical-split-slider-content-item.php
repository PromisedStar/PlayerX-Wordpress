<?php
namespace PlayerxCore\CPT\Shortcodes\VerticalSplitSliderContentItem;
...
class VerticalSplitSliderContentItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Slide Content Item', 'playerx-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Alignment', 'playerx-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Header/Bullets Style', 'playerx-core' ),
							'value'      => array(
								esc_html__( 'Default', 'playerx-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_core_get_shortcode_module_template_part( 'templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params );
