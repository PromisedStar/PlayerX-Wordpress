...
/**
 * Class PlayerxInstagramHelper
 */
class PlayerxInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines playerx_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'playerx_instagram_image_atts',
			array(
